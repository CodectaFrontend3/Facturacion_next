  ...
  { 
    ...
    cell: ({ row }) => (
      <div className="flex justify-center">
        <Link href={`/comprobantes/boleta/${row.original.id}`}>
    ...
    const mockData: BoletaRow[] = [
      {
        ...
        forma: "Credito",
        importe: "S/1,453.76",
        pagoInfo: { monto: "S/ 453.76", fecha: "10-07-2026", tipo: "Efectivo", dato: "volvo" }
      },
      {
        id: 10,
        nro: "B001-00000009",
        ...
        forma: "Credito",
        importe: "S/810.40",
        pagoInfo: { monto: "S/ 810.40", fecha: "10-07-2026", tipo: "Depósito", dato: "BCP" }
      }
    ];
