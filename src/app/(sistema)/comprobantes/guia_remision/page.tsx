...
export interface GuiaRemisionRow {
  id: string | number;
  nro: string;
  rucDni: string;
  destinatario: string;
...
const columns: ColumnDef<GuiaRemisionRow>[] = [
  ...
  { 
    ...
    cell: ({ row }) => (
      <div className="flex justify-center">
        <Link href={`/comprobantes/guia_remision/${row.original.id}`}>
...
export default function GuiaRemisionPage() {
  const [data, setData] = useState<GuiaRemisionRow[]>([]);
