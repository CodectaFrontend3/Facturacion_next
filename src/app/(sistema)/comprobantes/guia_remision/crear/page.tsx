...
export default function CrearGuiaRemisionPage() {
  ...
  const [puntoPartida, setPuntoPartida] = useState("Av. República de Panamá 3545, San Isidro, Lima");
  ...
  const handleGuardar = () => {
    const nuevaGuia = {
      id: Date.now(),
      nro: `T001-${Math.floor(Math.random() * 10000000).toString().padStart(8, '0')}`,
      rucDni: documento || "20100070031",
      destinatario: destinatario || "Destinatario General S.A.C.",
    ...
    const guardadas = JSON.parse(localStorage.getItem('guias_remision_guardadas') || '[]');
    guardadas.unshift(nuevaGuia); 
    localStorage.setItem('guias_remision_guardadas', JSON.stringify(guardadas));

    alert("¡Guía de Remisión generada con éxito!");
    router.push("/comprobantes/guia_remision"); 
  };
      ...
      <div className="w-full border border-gray-200 rounded-sm bg-white shadow-sm">
        ...
        <div className="px-5 py-3 border-b border-gray-100 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-[14px] font-bold text-gray-700">Generar Guía de Remisión Electrónica (Remitente)</h1>
          </div>
        </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-6 mb-8 bg-gray-50/50 p-5 border border-gray-200 rounded-md">
            ...
            <div className="space-y-4">
              <h3 className="text-[12px] font-extrabold text-[#2C1FF3] uppercase tracking-wider mb-2 border-b border-gray-200 pb-1">Datos del Envío y Transporte</h3>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                <label className="w-28 text-[12px] font-bold text-gray-600">Placa Vehículo:</label>
                <input
                  type="text"
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-[13px] font-extrabold text-gray-700">Detalle de Bienes a Trasladar</h3>
              <Button 
                  ...
                  {articulos.map((art) => (
                    <tr key={art.id} className="border-b border-gray-100 bg-white">
                      ...
                      <td className="py-2 px-3">
                        <input 
                          type="text" 
                          placeholder="Descripción del ítem transportado..."
