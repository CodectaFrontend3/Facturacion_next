...
export interface BoletaManualRow {
  id: string | number;
  nro: string;
  rucDni: string;
  cliente: string;
...
const columns: ColumnDef<BoletaManualRow>[] = [
  ...
  { 
    ...
    cell: ({ row }) => (
      <div className="flex justify-center">
        <Link href={`/comprobantes/boleta_manual/${row.original.id}`}>
...
export default function BoletasManualPage() {
  const [data, setData] = useState<BoletaManualRow[]>([]);
    ...
    const mockData: BoletaManualRow[] = [
      {
        ...
        nro: "BM01-00000004",
        rucDni: "45892134",
        cliente: "JUAN CARLOS PEREZ GOMEZ",
        emision: "15-07-2026",
        forma: "Contado",
        importe: "S/320.00",
        pagoInfo: { monto: "S/ 320.00", fecha: "15-07-2026", tipo: "Efectivo", dato: "Caja Principal" }
      },
      {
        id: 2,
        nro: "BM01-00000003",
        rucDni: "70891245",
        cliente: "MARIA ELENA ROJAS TORRES",
        emision: "14-07-2026",
        forma: "Contado",
        importe: "S/540.00",
        pagoInfo: { monto: "S/ 540.00", fecha: "14-07-2026", tipo: "Yape", dato: "Digital" }
      }
    ];
