"use client";
import ProcesoTabs from "@/app/(sistema)/servicio-tecnico/components/ProcesoTabs";
import { InformeTecnico } from "@/app/(sistema)/servicio-tecnico/types/servicios/InformeTecnico";
