...
export default function FacturacionElectronicaTemplate({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f3f3f4] p-6 font-sans">
      <div className="mb-5">
      ...
      <section className="bg-white rounded border border-gray-200 shadow-sm p-5">
        ...
        <div className="flex items-center gap-1.5 text-xs text-gray-600 font-sans py-3">
          <span>Ver</span>
          <select
            value={pageSize}
        ...
        <div className="mt-1 border border-gray-200 overflow-hidden">
          <DataTable
            columns={columns}
            data={filteredData}
            pageSize={pageSize}
