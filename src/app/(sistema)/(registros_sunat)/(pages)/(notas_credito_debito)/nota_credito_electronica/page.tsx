...
import { getNotaCreditoColumns } from "../config/columns"
import { type NotaRow } from "@/app/(sistema)/(registros_sunat)/types/notas"
...
export default function Page() {
  const columns = getNotaCreditoColumns()
  ...
  const handleSend = (selectedRows: NotaRow[]) => {
    console.log("Enviar notas de crédito seleccionadas a SUNAT:", selectedRows)
  }

  return (
    <RegistrosSunatTemplate<NotaRow>
      tabs={tabs}
      activeTab="nota_credito_electronica"
      cardConfigs={cardConfigs}
      cardCounts={cardCounts}
      cardPeriodLabel="Resumen de Junio del 2026"
      columns={columns}
      data={notasCreditoData as NotaRow[]}
      onSend={handleSend}
