...
import { getNotaDebitoColumns } from "../config/columns"
...
export default function Page() {
  const columns = getNotaDebitoColumns()
  ...
  const handleSend = (selectedRows: NotaRow[]) => {
    console.log("Enviar notas de débito seleccionadas a SUNAT:", selectedRows)
  }
