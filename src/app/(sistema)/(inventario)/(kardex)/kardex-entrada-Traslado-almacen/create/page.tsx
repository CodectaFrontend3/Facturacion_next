...
import { KardexTrasladoFormProps } from "../../../types/kardex";
import {
  KardexTrasladoFormValues,
  kardexTrasladoSchema,
...
function KardexTrasladoFormContent({
  ...
  const form = useForm<KardexTrasladoFormValues>({
    resolver: zodResolver(kardexTrasladoSchema) as any,
    defaultValues: {
      almacenEmisor,
      categoria: "PRODUCTOS",
      almacen: "",
      motivo: "Traslado de almacen",
      generarGuia: true,
                  ...
                  render={({ field }) => (
                    <FormItem className="flex items-center gap-0 space-y-0">
                      ...
                      <FormControl>
                        <Input
                          disabled
                          className="flex-1 bg-[#e9ecef] text-[12px] text-gray-600 font-medium"
                          {...field}
                        />
                      </FormControl>
                    </FormItem>
                    ...
                    <FormItem className="flex items-center gap-0 space-y-0">
                      ...
                      <div className="flex-1">
                        ...
                        >
                          ...
                          <SelectContent>
                            {almacenes
                              .filter((a) => a.value !== almacenEmisor)
                              .map((a) => (
...
export default function GenerarKardexTraslado(props: KardexTrasladoFormProps) {
  return (
    <Suspense
      fallback={
    ...
    >
      <KardexTrasladoFormContent {...props} />
    </Suspense>
  );
}
