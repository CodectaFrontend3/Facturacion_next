...
import { mapCotizacionDetail, normalizeCotizacionRawRow } from "@/app/(sistema)/ventas/_utils/legacy/mapDocumentDetail"
...
export default function CotizacionDetailPage() {
  ...
  return <DocumentDetailView variant="cotizacion" data={mapCotizacionDetail(normalizeCotizacionRawRow(rawRow))} useActionButtons />
}
