...
import { RowData, RenovacionState } from "@/app/(sistema)/ventas/_domain/legacy/documento.types"
import articulosMock from "@/app/(sistema)/ventas/data/legacy/articulo-mock.json"
