...
import { mapCotizacionManualDetail, normalizeCotizacionRawRow } from "../../utils/mapDocumentDetail"
...
export default function CotizacionManualDetailPage() {
  ...
  return <DocumentDetailView variant="cotizacion-manual" data={mapCotizacionManualDetail(normalizeCotizacionRawRow(rawRow))} />
}
