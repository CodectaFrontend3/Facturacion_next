import { ClienteRow, ClienteFormData } from "@/app/(sistema)/ventas/_domain/legacy/cliente.types"
import mockDataRaw from "@/app/(sistema)/ventas/data/legacy/cliente.json"
