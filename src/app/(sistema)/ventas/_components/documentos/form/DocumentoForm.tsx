...
const CONFIG_POR_TIPO: Record<DocumentoTipo, { titulo: string; rutaLista: string }> = {
  cotizacion: { titulo: "Generar Cotización", rutaLista: "/ventas/cotizacion" },
  cotizacion_manual: { titulo: "Generar Cotización Manual", rutaLista: "/ventas/cotizacion_manual" },
  nota_venta: { titulo: "Generar Nota de Venta", rutaLista: "/ventas/nota_venta" },
}
