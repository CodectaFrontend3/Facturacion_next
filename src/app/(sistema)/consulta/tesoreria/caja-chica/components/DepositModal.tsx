        ...
        <div className="max-h-[75vh] overflow-y-auto p-6 text-[13px] text-[#4b5563]">
          <div className="grid grid-cols-1 gap-x-6 gap-y-4 md:grid-cols-2">
              ...
              <div className="flex gap-2">
                <div className="w-[60%]">
                  <input
                    ...
                    placeholder="Nombres"
                    className={`h-[40px] w-full rounded-none border bg-white px-3 text-[#374151] outline-none transition-colors placeholder:text-[#9ca3af] ${fieldClass(errors.nombre)}`}
                  />
                ...
                <div className="w-[40%]">
                  <input
                    ...
                    placeholder="DNI"
                    maxLength={8}
                    className={`h-[40px] w-full rounded-none border bg-white px-3 text-[#374151] outline-none transition-colors placeholder:text-[#9ca3af] ${fieldClass(errors.dni)}`}
                  />
                  {errors.dni && <p className="mt-1 text-[11px] text-[#ef4444]">{errors.dni}</p>}
                </div>
              </div>
            </label>
            ...
            <label className="block">
              ...
              <div className={`flex h-[40px] items-center overflow-hidden rounded-none border bg-white ${errors.monto ? "border-[#ef4444]" : "border-[#d8d8d8] focus-within:border-[#2447b9]"}`}>
                <span className="flex h-full items-center justify-center bg-white pl-3 pr-1 text-[#6b7280]">S/</span>
                <input
                  type="text"
                  value={monto}
