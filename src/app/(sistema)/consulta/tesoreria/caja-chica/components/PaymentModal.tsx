      ...
      >
        ...
        <div className="max-h-[75vh] overflow-y-auto p-6 text-[13px] text-[#4b5563]">
          <div className="grid grid-cols-1 gap-x-6 gap-y-4 md:grid-cols-2">
            ...
            <label className="block">
              <span className="mb-1.5 block font-medium">Nombres:</span>
              <div className="flex h-[40px] w-full overflow-hidden rounded-[5px] border border-[#d8d8d8] bg-white focus-within:border-[#2447b9]">
                <input
                  type="text"
                  placeholder="Nombres"
                  className="h-full w-full px-3 text-[#374151] outline-none transition-colors placeholder:text-[#9ca3af]"
                />
                ...
                <input
                  type="text"
                  placeholder="DNI"
                  className="h-full w-[120px] shrink-0 px-3 text-[#374151] outline-none transition-colors placeholder:text-[#9ca3af]"
                />
              </div>
            </label>
            ...
            <label className="block">
              ...
              <div className="relative h-[40px] w-full">
                <select className="h-full w-full appearance-none rounded-[5px] border border-[#d8d8d8] bg-white px-3 pr-8 text-[#374151] outline-none transition-colors focus:border-[#2447b9]">
                  <option value="">Seleccione tipo</option>
                  <option value="caja">Caja</option>
                  <option value="personal">Personal</option>
                </select>
                <i className="bi bi-chevron-down absolute right-3 top-1/2 -translate-y-1/2 text-[12px] text-[#6b7280] pointer-events-none"></i>
              </div>
            </label>
            ...
            <label className={`block${paymentMethod === "Efectivo" ? " md:col-span-2" : ""}`}>
              ...
              <div className="flex h-[40px] items-center overflow-hidden rounded-[5px] border border-[#d8d8d8] bg-[#f3f4f6] focus-within:border-[#2447b9]">
                <span className="flex h-full items-center justify-center border-r border-[#d8d8d8] px-3 text-[#6b7280]">
                  S/
                </span>
                <input
                  type="text"
            ...
            {paymentMethod !== "Efectivo" && (
              <label className="block">
                ...
                <div className="flex h-[40px] w-full items-center gap-2 overflow-hidden rounded-[5px] border border-[#d8d8d8] bg-white">
                  <input type="file" className="hidden" id="file-upload-payment" />
                  <label
