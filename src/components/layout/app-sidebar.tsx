...
function getActiveMenuLabel(pathname: string) {
    ...
    return (activeItem && activeItem.subPath) ? activeItem.label : "";
}

export default function AppSidebar({ children }: { children?: ReactNode }) {
    const pathname = usePathname()
    const router = useRouter()
    const [openMenu, setOpenMenu] = useState<string>(() => getActiveMenuLabel(pathname))
    ...
    if (pathname !== prevPathname) {
        ...
        setOpenMenu(getActiveMenuLabel(pathname))
    }
